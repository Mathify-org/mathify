  ...
  return (
    <div className="bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100">
      <div className="container mx-auto px-4 py-10 md:py-16">
        ...
        <div className="max-w-3xl mx-auto space-y-4 md:space-y-6 mb-8 md:mb-16">
          <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-shadow">
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mb-2">What is Mathify?</h3>
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-shadow">
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mb-2">Is Mathify really free to use?</h3>
            <p className="text-slate-600">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-shadow">
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mb-2">What age groups is Mathify suitable for?</h3>
            <p className="text-slate-600">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-shadow">
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mb-2">How does Mathify help students learn?</h3>
            <p className="text-slate-600">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-shadow">
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mb-2">Can teachers use Mathify in their classrooms?</h3>
            <p className="text-slate-600">
