      ...
      <div className="container mx-auto px-4 py-10 md:py-16 flex-grow">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-4 md:p-8 hover:shadow-md transition-shadow">
          <div className="prose prose-slate max-w-full">
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Information We Collect</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">How We Use Your Information</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Cookies and Tracking</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Data Security</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Children's Privacy</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Changes to This Privacy Policy</h3>
            <p>
