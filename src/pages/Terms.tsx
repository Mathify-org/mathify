...
const Terms = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-indigo-100 flex flex-col">
      <div className="container mx-auto px-4 py-10 md:py-16 flex-grow">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-4 md:p-8 hover:shadow-md transition-shadow">
          <div className="prose prose-slate max-w-full">
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Use of Our Services</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">User Accounts</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Intellectual Property</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Prohibited Activities</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Disclaimer of Warranties</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Limitation of Liability</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Changes to These Terms</h3>
            <p>
            ...
            <h3 className="text-lg md:text-xl font-bold text-purple-700 mt-6 mb-2">Contact Us</h3>
            <p>
