        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-20 h-20 bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl flex items-center justify-center shadow-lg">
            ...
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-1">
              <div className="bg-white rounded-lg p-8">
                <div className="text-center">
                  ...
                  <h2 className="text-3xl font-bold text-purple-700 mb-4">How It Works</h2>
                  <div className="grid md:grid-cols-3 gap-6 mb-6">
                    <div className="bg-gradient-to-br from-purple-100 to-pink-100 p-4 rounded-lg">
                      ...
                      <div className="text-purple-700 font-medium">Questions</div>
                      <div className="text-sm text-slate-600">Fun math situations</div>
                    </div>
                    <div className="bg-gradient-to-br from-pink-100 to-purple-100 p-4 rounded-lg">
                      <div className="text-2xl font-bold text-pink-600 mb-2">Yes/No</div>
                      <div className="text-pink-700 font-medium">Answers Only</div>
                      <div className="text-sm text-slate-600">Simple choices</div>
                    </div>
                    <div className="bg-gradient-to-br from-indigo-100 to-purple-100 p-4 rounded-lg">
                      <div className="text-2xl font-bold text-indigo-600 mb-2">Learn</div>
                      <div className="text-indigo-700 font-medium">Every Answer</div>
                      <div className="text-sm text-slate-600">Instant explanations</div>
                    </div>
                  </div>
          ...
          <div className="text-center space-y-4">
            <Button
              onClick={startGame}
              size="lg"
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-0 px-12 py-6 text-2xl font-bold rounded-2xl shadow-xl transform hover:scale-105 transition-all"
            >
            ...
            <div>
              <Link to="/">
                <Button variant="outline" size="lg" className="mx-2 px-8 py-4 text-lg">
          ...
          <Card className="border-0 shadow-2xl bg-white/95 backdrop-blur-sm overflow-hidden">
            <div className={`bg-gradient-to-r ${color} p-1`}>
              <div className="bg-white rounded-lg p-8">
                ...
                <h1 className="text-4xl font-bold text-slate-800 mb-2">Test Complete!</h1>
                <p className="text-xl text-slate-600 mb-6">{message}</p>
                
                <div className="grid grid-cols-2 gap-6 mb-8">
                  <div className={`bg-gradient-to-r ${color.replace('to', 'to-opacity-20')} p-6 rounded-xl`}>
                    <div className="text-4xl font-bold text-slate-800">{stats.correctAnswers}</div>
                    <div className="text-slate-600">Correct Answers</div>
                    <div className="text-sm text-slate-500">out of {questions.length}</div>
                  </div>
                  <div className={`bg-gradient-to-r ${color.replace('to', 'to-opacity-20')} p-6 rounded-xl`}>
                ...
                <div className="space-y-4">
                  <Button
                    onClick={startGame}
                    size="lg"
                    className={`bg-gradient-to-r ${color} hover:opacity-90 text-white border-0 px-8 py-3 font-bold rounded-xl`}
                  >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 p-4">
      <div className="container mx-auto max-w-4xl">
        ...
        {/* Question Card */}
        <Card className="border-0 shadow-2xl bg-white/95 backdrop-blur-sm mb-6 overflow-hidden">
          {!showResult ? (
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-1">
                ...
                <div className="text-center">
                  ...
                  <div className="flex gap-6 justify-center">
                    <Button
                      ...
                      size="lg"
                      className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white border-0 px-12 py-6 text-xl font-bold rounded-2xl shadow-lg transform hover:scale-105 transition-all"
                    >
                    ...
                    <Button
                      ...
                      size="lg"
                      className="bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white border-0 px-12 py-6 text-xl font-bold rounded-2xl shadow-lg transform hover:scale-105 transition-all"
                    >
            ...
            <div className={`bg-gradient-to-r ${isCorrect ? 'from-green-500 to-emerald-600' : 'from-red-500 to-pink-600'} p-1`}>
              <div className="bg-white rounded-lg p-8 md:p-12">
                <div className="text-center">
                  <div className={`w-20 h-20 bg-gradient-to-r ${isCorrect ? 'from-green-500 to-emerald-600' : 'from-red-500 to-pink-600'} rounded-full flex items-center justify-center mx-auto mb-6 animate-bounce`}>
                    {isCorrect ? <CheckCircle className="h-10 w-10 text-white" /> : <XCircle className="h-10 w-10 text-white" />}
                  </div>
                  ...
                  <Button
                    ...
                    size="lg"
                    className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white border-0 px-8 py-4 text-lg font-bold rounded-xl"
                  >
