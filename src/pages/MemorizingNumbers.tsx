...
// First 50 digits of Pi for the game
const PI_DIGITS = "31415926535897932384626433832795028841971693993751";
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Test your memory by memorizing digits of π! Start with 3 digits and progress as far as you can.
          </p>
        </div>
