...
import { Star, Zap, Shield, Award, Medal, User } from 'lucide-react';
    ...
    <div className="flex flex-col items-center">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-extrabold mb-2 tracking-tight text-shadow-glow">
          <span className="text-yellow-300">Addition</span> Hero
        </h1>
          ...
          <div className="flex flex-col space-y-3">
            ...
            >
              <div>
                ...
                <div className="text-sm opacity-90">No time limit, focus on mastering the basics</div>
              </div>
            </Button>
      ...
      <div className="mt-10 bg-white/10 rounded-lg p-4 max-w-4xl w-full backdrop-blur-sm">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm">
          <li>Equations will fall from the sky - solve them before they hit the ground!</li>
          ...
          <li>Unlock new levels by reaching score thresholds</li>
