...
const FallingProblem: React.FC<FallingProblemProps> = ({ 
  ...
  // Different background colors based on problem type/powerup
  ...
  return (
    ...
    >
      ...
      {/* Meteor trail effect */}
      <div className="absolute left-1/2 -z-10 transform -translate-x-1/2 -top-8 w-5 h-20 bg-gradient-to-t from-orange-500 to-transparent opacity-50 rounded-full blur-sm" />
    </motion.div>
  );
};
